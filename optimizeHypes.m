function [hyp,alpha,sigmasq,invC,R] = optimizeHypes(Initial_theta, theta, x_sample, y_sample, R_before, r, Iteration, divider, solvertype) % optimize hyperparameters based on MLE
