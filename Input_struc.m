...
S.prob.maxiter = 1500;                                                                                    % Maximum iterations for Bayesopt
...
S.Hypopt.initheta = zeros(1,S.prob.dim);                                                                  % Initial hyperparameters for MLE process
...
S.add.standard = zeros(S.prob.maxiter,6);                                                                 % Storage of the data for scaling
